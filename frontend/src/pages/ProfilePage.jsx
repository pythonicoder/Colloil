...
const ProfilePage = () => {
  ...
  const achievements = [
    { id: 1, name: 'First Drop', description: 'First oil collection', earned: (user?.total_oil_liters || 0) >= 1 },
    { id: 2, name: 'Eco Starter', description: 'Collected 5L', earned: (user?.total_oil_liters || 0) >= 5 },
    { id: 3, name: 'Green Champion', description: 'Collected 10L', earned: (user?.total_oil_liters || 0) >= 10 },
    { id: 4, name: 'Planet Saver', description: 'Collected 50L', earned: (user?.total_oil_liters || 0) >= 50 },
  ];
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary-600 flex items-center justify-center text-white font-outfit font-bold text-2xl">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="bg-primary-50 rounded-xl p-3 text-center">
              <p className="text-2xl font-bold text-primary">{user?.total_oil_liters?.toFixed(1) || '0'}L</p>
              <p className="text-xs text-stone-500">Total Oil</p>
            </div>
            <div className="bg-secondary-50 rounded-xl p-3 text-center">
              <p className="text-2xl font-bold text-secondary">{user?.total_glycerin_liters?.toFixed(1) || '0'}L</p>
              <p className="text-xs text-stone-500">Total Glycerin</p>
            </div>
          </div>
        </motion.div>
