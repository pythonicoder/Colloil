...
const AuthPage = () => {
  ...
  const [isExoticOwner, setIsExoticOwner] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        if (isExoticOwner && (!petType || !petName)) {
          toast.error("Please enter pet info");
          setLoading(false);
          return;
        }
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pb-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Exotic Pet Owner Section */}
            {!isLogin && (
              <>
                <div className="flex items-center gap-2 mt-2">
                  <input
                    type="checkbox"
                    checked={isExoticOwner}
                    onChange={(e) => setIsExoticOwner(e.target.checked)}
                  />
              ...
              {isExoticOwner && (
                <>
                  <div>
                    ...
                    <Input
                      placeholder="Snake, Iguana, Parrot..."
                      value={petType}
